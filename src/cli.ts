 ...
 *   rocket2matter package
 *   rocket2matter reset-password [--dry-run]
 */
...
const HELP = `Rocket2Matter ${pkg.version} — migration RocketChat → Mattermost

Usage : rocket2matter <commande> [options]
